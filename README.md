...
Filtered EVs under 350,000 PLN with range ≥ 400 km and calculated manufacturer-wise average battery capacity.
# Taske 2 - Outlier Detection
Identified unusual energy consumption vehicles using IQR method and visualizations.
# Taske 3 - Relationship Analysis
Analyzed correlation between battery capacity and driving range.
# Task 4 - EV Recommendation System
Built a Python class recommending top EVs based on budget, range, and battery capacity.
